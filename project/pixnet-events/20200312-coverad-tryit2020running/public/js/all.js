...
if (!window.__trackdev) {
    window.__paId = '33-5e5e0468aa381'; // 0307 update
    window.__gaId = 'UA-123826457-8'; // 0312 update
    // https://flyad.events.pixnet.net/pei.gif?year=2020&group=flyad-tryit2020running&url=URL&t=TIME
    window.__imageSrc = 'flyad';
    window.__ckEvent = {
        'year': '2020',
        'group': 'flyad-tryit2020running'
    };
