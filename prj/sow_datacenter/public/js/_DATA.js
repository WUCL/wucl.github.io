...
if (window._comm.$testMode) {
    window._comm.$api.param.key = 'e8701ad48ba05a91604e480dd60899a3';
    window._comm.$user.id = '11';
    window._comm.$user.name = 'Allen Wu';
    window._comm.$user.email = 'allenwu8098@gmail.com';
}
