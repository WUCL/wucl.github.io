<?php
/* Template Name: template-co-album
* 活動相簿
*/
/**
* @package Make
...
<html lang="zh-Hant">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../wp-content/assets/css/album.min.css" />
    </head>
    <body data-page="album">
        ...
        <main id="main" class="main">
            ...
            <section class="albums">
                <div class="inner">
                    <div class="albums_box withfilter-box">
        ...
        <section id="view-album">
            <div class="popup_inner">
                ...
                <div class="va-pic_box withfilter-box">
                    <div class="va-pic-filter in-filter">
                        <form class="form_filters-b" name="form_filters-album" onsubmit="return false;">
        ...
        <script src="../wp-content/assets/js/album.js"></script>
    </body>
</html>